...
export const pointsInner: Point[] = Array.from({ length: NUM_POINTS }, (_, k) => k + 1).map((num) => {
...
export const pointsOuter: Point[] = Array.from({ length: NUM_POINTS / 4 }, (_, k) => k + 1).map((num) => {
